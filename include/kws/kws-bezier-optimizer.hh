...
# define KWS_BEZIER_OPTIMIZER_BEZIER_OPTIMZIER_HH_

#include "kws/bezier-optimizer/fwd.hh"
#include "kws/bezier-optimzier/io.hh"
#include "kws/bezier-optimizer/optimizer.hh"

#endif //! KWS_BEZIER_OPTIMIZER_BEZIER_OPTIMZIER_HH_
